...
export default [
  {
    ignores: ["node_modules/**", "dist/**", "release-artifacts/**", "src-tauri/**", ".worktrees/**"],
  },
  ...
  },
  {
    ...
    rules: {
      "no-restricted-syntax": [
        ...
        colorLiteralRestriction,
      ],
    },
  },
  {
    files: panelShellFiles,
    rules: {
      "no-restricted-syntax": [
        "error",
        {
    ...
    rules: {
      "no-restricted-syntax": [
        "error",
        {
          ...
          message: "Use `ToastViewport` for toast region wrappers instead of raw `<div>` wrappers.",
        },
        {
          selector:
            "JSXOpeningElement[name.name='div'] > JSXAttribute[name.name='className'][value.value=/^(approval-toast|error-toast|update-toast)$/]",
          message: "Use `ToastCard` for toast cards instead of raw `<div>` wrappers.",
        },
        {
          selector:
        ...
        {
          selector: "JSXOpeningElement[name.name='div'] > JSXAttribute[name.name='aria-live']",
          message:
